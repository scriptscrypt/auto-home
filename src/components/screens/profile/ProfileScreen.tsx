...
import { EmerContactTable } from "../../tables/EmerContactTable";
import BarGraphCard from "../../cards/BarGraphCard";
  ...
  return (
    <>
      <div className="w-1/2 p-8">
        ...
        >
          Your Futuristic Smart Home tinkerer
        </Typography>
        <div className="mt-6 flex items-center gap-8 border-t border-blue-gray-50 pt-4">
          ...
          >
            ...
            No 23, Rajajinagar, Bengaluru, Karnataka
          </Typography>
        </div>
